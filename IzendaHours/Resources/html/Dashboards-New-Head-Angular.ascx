...
<script type="text/javascript">
  var urlSettingsConfig = {
    urlResponseServer: '<%=AdHocSettings.ResponseServer%>',
    urlDashboardViewer: '<%=AdHocSettings.DashboardViewer%>',
    urlDashboardDesigner: '<%=AdHocSettings.DashboardDesignerUrl%>',
    urlReportViewer: '<%=AdHocSettings.ReportViewer%>',
    urlInstantReport: '<%=AdHocSettings.InstantReport%>',
    urlReportDesigner: '<%=AdHocSettings.ReportDesignerUrl%>',
    urlReportList: '<%=AdHocSettings.ReportList%>',
    urlSettings: '<%=AdHocSettings.SettingsPageUrl%>'
  };
  window.urlSettings$ = UrlSettings(urlSettingsConfig);
  window.urlSettings$.replaceRnForAngularApp();
</script>
