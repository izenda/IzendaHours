...
<%@ Import Namespace="Izenda.AdHoc" %>
    ...
    <div id="loadingrv2" style="z-index:500;top:0;left:0;width:100%;background-color:#FFFFFF;position:fixed;display:none;text-align:center;vertical-align:middle;" lang-text="js_Loading">
        Loading...<br />
        <img alt="" src="rs.aspx?image=loading.gif" />
    </div>

    <div id="saveAsDialog" style="z-index:515;top:0;left:0;width:100%;position:absolute;display:none;text-align:center;vertical-align:middle;">
    ...
    <div><input type="text" id="newReportName" style="width:200px;margin:0; border-style:solid; border-width:1px;" value="" /></div>
    ...
    <div id="newCatDialog" style="z-index:515;top:0;left:0;width:100%;position:absolute;display:none;text-align:center;vertical-align:middle;">
    <div style="padding:20px; border-style:solid; border-width:1px; background-color:#FFFFFF;   display: table;   margin: 0 auto;">
    <div lang-text="js_NewCategoryName">New category name</div>
    <div><input type="text" id="addedCatName" style="width:200px;margin:0;border-style:solid; border-width:1px;" value="" /></div>
    <div style="margin-top:5px;">
            <div class="f-button" style="margin-bottom: 4px;">
    ...
    <div id="popupEsDialog" style="z-index:515;top:0;left:0;width:100%;position:absolute;display:none;text-align:center;vertical-align:middle;">
...
<div id="loadingDiv" style="width: 100%; text-align: center; display: none;">
    <div id="loadingWord" style="font-size: 20px;color:#1D5987;font-family:Verdana,Arial,Helvetica,sans-serif;font-weight:normal !important; font-style: normal;" lang-text="js_Loading">Loading...</div>
    <img style="padding-top: 40px;" id="loadingImg" alt="" src="rs.aspx?image=loading.gif" />
</div>

<div style="position: relative; margin: 0 8px; padding: 60px 6px 0; color:#000">
  ...
  <div class="btn-group cool designer-only hide-locked hide-viewonly" id="saveControls">
    ...
    <ul id="izendaDrop" class="dropdown-menu">
      <li class="hide-readonly"><a href="javascript:void(0)" style="min-width: 18em;"
        ...
        <b id="izendaTool" lang-text="js_Save">Save</b><br>
        <span id="izendaTool" lang-text="js_SaveChangesMessage">Save changes to the report for everyone it is shared with</span>
      </a></li>
      <li><a href="javascript:void(0)" style="min-width: 18em;"
        ...
        <b id="izendaTool" lang-text="js_SaveAs">Save As</b><br>
        <span id="izendaTool" lang-text="js_SaveACopyMessage">Save a copy with a new name, keeping the original intact</span>
      </a></li>
    </ul>
  </div>
  <div class="btn-group cool">
    ...
    <ul class="dropdown-menu">
      <li><a href="javascript:void(0)" title="" style="min-width: 18em;"
        ...
        <b id="izendaTool" lang-text="js_PrintHTML">Print HTML</b><br>
        <span id="izendaTool" lang-text="js_PrintDirectlyMessage">Print directly from your browser, the fastest way for modern browsers</span>
      </a></li>
      <li>
        ...
        <b id="izendaTool" lang-text="js_HTML2PDF">HTML-powered PDF</b><br>
        <span id="izendaTool" lang-text="js_HTML2PDFMessage">One-file compilation of all the report's pages</span></a>
        ...
        <b id="izendaTool" lang-text="js_StandardPDF">Standard PDF</b><br>
        <span id="izendaTool" lang-text="js_NonHTMLPDF">Non-HTML PDF generation</span></a>
      </li>
    </ul>
  </div>  
  <div class="btn-group cool">
    ...
    <ul class="dropdown-menu">
      <li><a href="javascript:void(0)" title="" style="min-width: 18em;"
        ...
        <b id="izendaTool" lang-text="js_ExportToExcel">Export to Excel</b><br>
        <span id="izendaTool" lang-text="js_ExportToExcelMessage">File for Microsoft's spreadsheet application</span>
      </a></li>
      <li><a href="javascript:void(0)" title="" 
        ...
        <b id="izendaTool" lang-text="js_WordDocument">Word document</b><br>
        <span id="izendaTool" lang-text="js_WordDocumentMessage">File for Microsoft's word processor, most widely-used office application</span>
      </a></li>
      <li><a id="csvExportBtn" href="javascript:void(0)" title="" 
        ...
        <b id="izendaTool" lang-text="js_CSV">CSV</b><br>
        <span id="izendaTool" lang-text="js_CSVMessage">Stores tabular data in text file, that can be used in Google Docs</span>
      </a></li>
      <li><a href="javascript:void(0)" title="" 
        ...
        <b id="izendaTool" lang-text="js_XML">XML</b><br>
        <span id="izendaTool" lang-text="js_XMLMessage">Both human-readable and machine-readable text file</span>
      </a></li>
      <!--
  ...
  <div class="btn-group cool" data-toggle="buttons-radio">
    ...
    <ul class="dropdown-menu">
      <li onclick="ChangeTopRecords(1, true);" id="resNumLi0"><a href="javascript:void(0)" title="" style="min-width: 12em;">
        ...
        <b id="izendaTool" lang-text="js_Result_1">1 Result</b><br />
        <span id="izendaTool" lang-text="js_Result_1_Message">Ideal for large forms</span>
      </a></li>
      <li onclick="ChangeTopRecords(10, true);" id="resNumLi1"><a href="javascript:void(0)" title="">
        ...
        <b id="izendaTool" lang-text="js_Result_10">10 Results</b><br />
        <span id="izendaTool" lang-text="js_Result_10_Message">Good for single parameter reports</span>
      </a></li>
      <li onclick="ChangeTopRecords(100, true);" id="resNumLi2"><a href="javascript:void(0)" title="">
        ...
        <b id="izendaTool" lang-text="js_Result_100">100 Results</b><br />
        <span id="izendaTool" lang-text="js_Result_100_Message">Default and recommended value</span>
      </a></li>
      <li onclick="ChangeTopRecords(1000, true);" id="resNumLi3"><a href="javascript:void(0)" title="">
        ...
        <b id="izendaTool" lang-text="js_Result_1000">1000 Results</b><br />
        <span id="izendaTool" lang-text="js_Result_1000_Message">Good for larger reports</span>
      </a></li>
      <li onclick="ChangeTopRecords(10000, true);" id="resNumLi5"><a href="javascript:void(0)" title="">
        ...
        <b id="izendaTool" lang-text="js_Result_10000">10000 Results</b><br />
        <span id="izendaTool" lang-text="js_Result_10000_Message">10000 Results</span>
      </a></li>     
      <li class="divider"></li>
      <li onclick="ChangeTopRecords(-1, true);" id="resNumLi4"><a href="javascript:void(0)" title="">
        ...
        <b id="izendaTool" lang-text="js_Result_All">Show all results</b><br>
        <span id="izendaTool" lang-text="js_Result_All_Message">Use carefully as this may overload the browser</span>
      </a></li>
    </ul>
  </div>  
  <div class="btn-group">
    ...
    <div class="tab-pane" id="tab1">
                ...
                <tr>
                    <td class="subreportsFiltersContent" style="display:none;">
                        <div class="subreportsFiltersTitle" onclick="ToggleSubreportsFiltersControl();" style="height: 1px; background-color: #aaa; text-align: center; cursor: pointer;">
                            <span class="subreportsCollapse" style="background-color: white; position: relative; color: #aaa;top: -13px;font-size: 18px;padding: 0 10px; float:left; margin-left:10px; display:none;">+</span>
                            <span class="subreportsExpand" style="background-color: white; position: relative; color: #aaa;top: -13px;font-size: 18px;padding: 0 10px; float:left;margin-left:10px;">-</span>
                            <span class="subreportsTitleText" style="background-color: white; position: relative; color: #aaa;top: -13px;font-size: 18px;padding: 0 10px;">Subreports</span>
                            <span class="subreportsCollapse" style="background-color: white; position: relative; color: #aaa;top: -13px;font-size: 18px;padding: 0 10px; float:right; margin-right:10px; display:none;">+</span>
                            <span class="subreportsExpand" style="background-color: white; position: relative; color: #aaa;top: -13px;font-size: 18px;padding: 0 10px; float:right; margin-right:10px;">-</span>
                        </div>
        ...
        <div style="display:none;">
            ...
            <div class="subreportTitleTemplate" style="height: 1px; background-color: #aaa; margin-top: 16px; margin-bottom: 16px; text-align:center;">
                <span style="background-color: white; position: relative; color: #aaa;top: -11px;font-size: 16px;padding: 0 10px;"></span>
            </div>
        </div>
    </div>
        ...
        <div id="fieldPropertiesDialogContainer">
            <div id="data-source-field" title="Field name" lang-title="js_FieldName">
	            <div id="propertiesDiv">
		            <div id="titleDiv" style="margin: 0; text-align:left;text-transform:capitalize;color:#fff;background-color:#1C4E89;padding:6px; width: 100%; max-width: 388px;"></div>
		            <div>
			            <div style="float: left; width: 100%; max-width: 400px;margin-right: 50px;">
				            <table cellpadding="0" cellspacing="0" style="width: 100%;">
					            ...
					            <tr><td><input id="propDescription" type="text" value="" style="width:100%;margin:0;"/></td></tr>
					            <tr><td style="padding-top:10px;" lang-text="js_Format">Format</td></tr>
					            <tr><td><select id="propFormats" style="margin:0;width:100%;"></select></td></tr>
					            ...
					            <tr><td><select id="propFilterOperators" style="margin:0;width:100%;"></select></td></tr>
				            </table>
