  ...
  public class CustomAdHocConfig : DatabaseAdHocConfig {
    public static void InitializeReporting() {
      if (HttpContext.Current.Session == null || HttpContext.Current.Session["ReportingInitialized"] != null)
        return;
      AdHocSettings.LicenseKey = "T367 DEV +DASH +MAPS +LANG +FORMS +VISION +FUSION|Enterprise|6.8|12/30/2014|0|0|0|M|ZKDFCCG";
      AdHocSettings.SqlServerConnectionString = @"Server=IEOne;Database=Northwind;Trusted_Connection=true;";
